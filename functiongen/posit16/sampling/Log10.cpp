...
int main(int argc, char** argv) {
    ...
    PolySynth<posit16, Elementary<posit16>> p16log10(SAMPLE, 200);
    p16log10.SetUpSamplingOption(0.75, 1.5);
    p16log10.CalcIntervals();
    
    do {
        printf("FINDING POLYNOMIALS\n");
        p16log10.ResetPolynomials();
        p16log10.FindPolynomials({1, 3, 5, 7, 9});
        printf("\tCOMPLETED\n\n");
    } while (p16log10.TestAndAddSamplePoints());
