...
int main(int argc, char** argv) {
    ...
    PolySynth<posit16, Elementary<posit16>> p16log2(SAMPLE, 200);
    p16log2.SetUpSamplingOption(0.75, 1.5);
    p16log2.CalcIntervals();
    
    do {
        printf("FINDING POLYNOMIALS\n");
        p16log2.ResetPolynomials();
        p16log2.FindPolynomials({1, 3, 5, 7, 9});
        printf("\tCOMPLETED\n\n");
    } while (p16log2.TestAndAddSamplePoints());
