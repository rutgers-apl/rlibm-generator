...
int main(int argc, char** argv) {
    ...
    PolySynth<bfloat16, Elementary<bfloat16>> bf16exp10(SAMPLE, 200);
    bf16exp10.SetUpSamplingOption(0, 0.302);
    bf16exp10.CalcIntervals();
    
    do {
        printf("FINDING POLYNOMIALS\n");
        bf16exp10.ResetPolynomials();
        bf16exp10.FindPolynomials({0, 1, 2, 3, 4});
        printf("\tCOMPLETED\n\n");
    } while (bf16exp10.TestAndAddSamplePoints());
